...
import os
from src.vacation_planner.strands_agent import plan_vacation
...
st.markdown('<p class="subtitle">Plan your perfect vacation with AI-powered research and itinerary planning! (Powered by Strands Agents)</p>', unsafe_allow_html=True)
...
if submitted and destination:
    with st.spinner("🌍 Planning your amazing vacation... This may take a few minutes."):
        try:
            ...
            status_text.text('🔍 Researching destination with Strands Agent...')
            progress_bar.progress(25)
            
            # Run the Strands vacation planner
...
with st.sidebar:
    ...
    st.markdown("**Strands Agents SDK** + **Amazon Bedrock Nova Pro**")
    st.markdown("---")
    st.markdown("### 📊 Stats")
